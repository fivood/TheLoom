...
const SECTIONS: Section[] = [
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li><b>网页版</b>:数据在浏览器里;换机器前先「工具 → 存储管理 → 全部导出为 zip」,或配好云同步</li>
          ...
          <li><b>工作区预设</b>:小说 / 互动叙事 / 通用三套,只改模块排序与命名,不锁功能</li>
          <li><b>写作阶段</b>(小说预设):顶栏「写 / 改 / 理」三档。写 = 只留正文;改 = 查找替换、快照、版本差异与批注在手边;理 = 大纲 / 时间线 / 规划优先,正文按块整理。阶段是本机设置,不写入作品</li>
        </ul>
    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li><b>专注模式</b>:工具栏「专注」进入纯文本沉浸写作,退出时按段落次序保留块身份</li>
    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li><b>伏笔台账</b>:埋设 / 回收位置,状态自动推导;「缺埋设」= 有回收却没埋过</li>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>外链网盘的要点:</p>
        <ul>
          <li>远端按<b>作品名</b>分目录,多部作品互不覆盖;面板里「查看远端作品」可挑着拉</li>
          <li>还没起名的作品不能上传 —— 都叫「未命名项目」会在远端互相覆盖</li>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p><b>AI 辅助</b>:工具菜单 →「AI 设置」配 Key →「AI 抽取」把长文里的实体 / 场景 / 时间点抽出来,

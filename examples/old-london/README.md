...
> 内容说明:改编自作者本人的同名短篇,维多利亚时代老伦敦背景的寻人谜案,含轻度成人向情节(吸血、亲密描写)。正文一字未改,示例只做结构化。

## 内容一览

| 模块 | 内容 |
|---|---|
| 卷章场景 | 1 卷 4 章 12 场景,约 1.2 万字,带状态 / POV / 地点 / 故事时间 / 情节张力 |
...
- 小说通道:12 场景树序正确、三种编译格式产出正常、两套 DOCX 预设导出后重解析自检通过(投稿稿 243 段 / 编辑审阅稿 268 段)、体检 0 问题、JSON 往返无损
